...
//   return (
//     <div className="lg:w-64 border-r hidden md:block sm:w-[220px] pr-3 sticky top-0 h-screen overflow-y-auto">
//       {/* Categories */}
//       <ul className="mb-6">
//         {categories.map(cat => (
//           <li
...
export default function Sidebar({
  ...
  const handleCategoryClick = (_cat: Category) => {
    // ❌ window.open বাদ দাও
    navigate("/error"); // ✅ এখানে ErrorPage route
  };
      ...
      <ul className="mb-6">
        {categories.map(cat => (
          <li
            ...
            onClick={() => handleCategoryClick(cat)} // ✅ শুধু এখানে পরিবর্তন
          >
            {cat.title}
          </li>
        ))}
