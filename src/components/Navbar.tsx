...
const Navbar: React.FC<NavbarProps> = ({ onSearch }) => {
  ...
  return (
    <div className="w-full bg-white pb-sm">
      {/* --- Top info bar --- */}
      ...
      {/* --- Main navbar --- */}
      <div className="max-w-[1470px] mx-auto px-4 py-3 flex items-center justify-between gap-5">
        {/* Logo */}
        ...
        {/* Search bar */}
        <div className="flex-1 max-w-[1190px] relative">
          <input
            type="text"
            placeholder="Search Here"
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            className="w-full pl-4 pr-12 py-2 rounded-l-xl rounded-r-xl border-b bg-[#F2F5F3] outline-none focus:ring-1 focus:ring-[#470096]"
          />
          <button
